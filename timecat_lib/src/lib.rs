...
pub mod prelude {
    ...
    pub use super::{
        ...
        King, Knight, Pawn, Piece, PieceType, Queen, Rank, RepetitionTable, Rook, Square,
        StringifyMove, SubBoard, SubBoardBuilder, TimecatError, TranspositionTable,
        ValidOrNullMove, White, Zobrist, A1, A2, A3, A4, A5, A6, A7, A8, ALL_FILES,
        ...
        BB_UPPER_HALF_BOARD, C1, C2, C3, C4, C5, C6, C7, C8, D1, D2, D3, D4, D5, D6, D7, D8, E1,
